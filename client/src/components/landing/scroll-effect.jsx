...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="mx-auto min-h-[200vh] max-w-full shrink-0 overflow-hidden py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-20"
    >
      <div className="sticky top-[10vh] flex flex-col items-center justify-start h-screen">
        <motion.h2
          style={{
            translateY: textTransform,
            opacity: textOpacity,
          }}
          className="mb-20 text-center text-3xl font-bold text-neutral-800 dark:text-white mt-10 md:mt-20">
          {title || (
            <span>
...
export const Lid = ({
  ...
  return (
    <div className="relative w-[32rem] [perspective:800px]">
      <div
        style={{
        ...
        className="relative h-[14rem] w-[30rem] rounded-2xl bg-[#010101] p-2">
        <div
          style={{
      ...
      <motion.div
        ...
        <img
          src={src}
          alt="aceternity logo"
          className="absolute inset-2 h-[calc(100%-1rem)] w-[calc(100%-1rem)] rounded-sm object-cover object-center bg-[#1a1a1a]" />
      </motion.div>
    </div>
  );
};
