...
import { LayoutDashboard, KanbanSquare, FolderOpen, Users, Plus, Target, Flame, Settings } from 'lucide-react';
  ...
  return (
    <div className="w-64 bg-gray-50 h-screen border-r border-gray-200 flex flex-col p-6 fixed left-0 top-0 overflow-y-auto">
      ...
      <div className="flex-1 space-y-6">
        ...
        {/* Group 2: Insights */}
        <div>
          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 px-2">Insights</p>
          <nav className="space-y-2">
            <NavItem to="/focus" icon={<Target size={20} />} label="Focus Mode" />
            <NavItem to="/burnout" icon={<Flame size={20} />} label="Burnout Radar" />
          </nav>
        </div>
      </div>
